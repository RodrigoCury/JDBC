package br.dev.rodrigocury.view;
...
import br.dev.rodrigocury.contollers.CategoriaController;
import br.dev.rodrigocury.contollers.ProdutoController;
...
public class ProdutoCategoriaFrame extends JFrame {
	...
	public ProdutoCategoriaFrame() {
		...
		comboCategoria.addItem(new Categoria("Selecione", 0));
